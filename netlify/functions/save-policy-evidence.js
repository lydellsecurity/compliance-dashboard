...
// Generate PDF from policy markdown with professional LYDELL SECURITY layout
    ...
    try {
      ...
      const doc = new PDFDocument({
        ...
        info: {
          ...
          Creator: 'Lydell Security Compliance Engine',
          Producer: 'LYDELL SECURITY GRC Platform',
          Keywords: `${metadata.controlId}, Security Policy, Compliance, ${metadata.frameworks || 'SOC 2, ISO 27001'}`,
        },
      ...
      // ========================================
      // PROFESSIONAL LYDELL SECURITY HEADER
      // ========================================
      ...
      doc.fontSize(28).font('Helvetica-Bold').fillColor('#1f2937')
        .text('LYDELL SECURITY', { align: 'center' });
      doc.moveDown(0.2);
      ...
      doc.font('Helvetica').fillColor('#111827')
        .text(metadata.companyName || 'LYDELL SECURITY', 380, infoBoxY + 12);
      ...
      doc.fontSize(8).font('Helvetica').fillColor('#9ca3af')
        .text(
          `Generated by LYDELL SECURITY GRC Platform | ${metadata.companyName || 'LYDELL SECURITY'} | Confidential`,
