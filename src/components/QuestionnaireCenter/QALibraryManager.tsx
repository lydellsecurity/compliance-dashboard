    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-midnight-900 rounded-xl border border-slate-200 dark:border-steel-700 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500 dark:text-steel-400 dark:text-steel-400">Library Entries</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-midnight-900 rounded-xl border border-slate-200 dark:border-steel-700 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-900 dark:text-steel-100">{stats.highConfidence}</p>
              <p className="text-sm text-slate-500 dark:text-steel-400 dark:text-steel-400">High Confidence</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-midnight-900 rounded-xl border border-slate-200 dark:border-steel-700 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-900 dark:text-steel-100">{stats.totalUsage}</p>
              <p className="text-sm text-slate-500 dark:text-steel-400 dark:text-steel-400">Total Usage</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-midnight-900 rounded-xl border border-slate-200 dark:border-steel-700 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-900 dark:text-steel-100">{stats.recentlyUsed}</p>
              <p className="text-sm text-slate-500 dark:text-steel-400 dark:text-steel-400">Used (30d)</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-midnight-900 rounded-2xl border border-slate-200 dark:border-steel-700 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-steel-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-semibold text-slate-900 dark:text-steel-100">QA Library</h3>
              <p className="text-sm text-slate-500 dark:text-steel-400 dark:text-steel-400">Approved answers for future questionnaires</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-slate-600 dark:text-steel-300 hover:text-slate-800 dark:hover:text-steel-100 hover:bg-slate-100 dark:hover:bg-steel-700 rounded-lg transition-colors flex items-center gap-2"
            >
        ...
        {/* Filters */}
        <div className="px-6 py-3 border-b border-slate-100 dark:border-steel-700 bg-slate-50 dark:bg-midnight-800 flex items-center gap-4">
          ...
          <select
            ...
            className="text-sm border border-slate-200 dark:border-steel-700 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-violet-500 bg-white dark:bg-midnight-900 text-slate-900 dark:text-steel-100"
          >
        ...
        <div className="max-h-[500px] overflow-y-auto">
          {filteredItems.length === 0 ? (
            <div className="py-12 text-center">
              ...
              <h3 className="text-lg font-medium text-slate-900 dark:text-steel-100 mb-1">
            ...
            <div className="divide-y divide-slate-100 dark:divide-steel-700">
              {filteredItems.map(item => {
                ...
                return (
                  <div key={item.id} className="hover:bg-slate-50 dark:hover:bg-steel-800 transition-colors">
                    <button
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-sm text-slate-900 dark:text-steel-100 line-clamp-2">
                            {item.questionText}
                          </p>
                          <div className="flex items-center gap-3 mt-2">
                            ...
                            {item.category && (
                              <span className="px-2 py-0.5 bg-slate-100 dark:bg-steel-700 text-slate-600 dark:text-steel-300 rounded text-xs">
                                {item.category}
                              </span>
                            )}
                        ...
                        <div className="flex items-center gap-1 flex-shrink-0">
                          ...
                          <button
                            ...
                            className="p-2 text-slate-400 dark:text-steel-500 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-lg transition-colors"
                          >
                        ...
                        >
                          <div className="ml-8 space-y-3">
                            <div className="bg-violet-50 border border-violet-200 rounded-xl p-4">
                              ...
                              <p className="text-sm text-slate-900 dark:text-steel-100 whitespace-pre-wrap">
                                {item.standardAnswer}
                              </p>
                            </div>
                            ...
                            {item.relatedControls.length > 0 && (
                              <div className="flex items-center gap-2 flex-wrap">
                                <span className="text-xs text-slate-500 dark:text-steel-400 dark:text-steel-400">Related Controls:</span>
                                {item.relatedControls.map(control => (
                                  <span
                                    key={control}
                                    className="px-2 py-0.5 bg-slate-100 dark:bg-steel-700 text-slate-600 dark:text-steel-300 rounded text-xs font-mono"
                                  >
                                    {control}
                                  </span>
                                ))}
        ...
        {isEditing && selectedItem && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-midnight-900 rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden"
            >
              <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200 dark:border-steel-700">
                <h3 className="font-semibold text-slate-900 dark:text-steel-100">Edit Library Entry</h3>
                <button
                  onClick={() => setIsEditing(false)}
                  className="p-2 text-slate-400 dark:text-steel-500 hover:text-slate-600 dark:hover:text-steel-300 hover:bg-slate-100 dark:hover:bg-steel-700 rounded-lg transition-colors"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="p-6 space-y-4">
                <div>
                  ...
                  <p className="p-3 bg-slate-50 dark:bg-midnight-800 rounded-xl text-sm text-slate-700 dark:text-steel-300">
              ...
              <div className="flex items-center justify-end gap-3 px-6 py-4 bg-slate-50 dark:bg-midnight-800 border-t border-slate-200 dark:border-steel-700">
                <button
                  onClick={() => setIsEditing(false)}
      ...
      <div className="bg-violet-50 border border-violet-200 rounded-xl p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-medium text-violet-900 dark:text-violet-300">AI Learning</h4>
