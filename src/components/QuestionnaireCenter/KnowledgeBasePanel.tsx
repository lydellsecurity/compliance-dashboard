  ...
  if (isLoading) {
    return (
      <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
        ...
        <h3 className="text-lg font-semibold text-slate-900 mb-2">Building Knowledge Base</h3>
        <p className="text-slate-500">Aggregating compliance data for AI context...</p>
      </div>
    );
  }
  ...
  if (!knowledgeBase) {
    return (
      <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
        ...
        <h3 className="text-lg font-semibold text-slate-900 mb-2">Knowledge Base Unavailable</h3>
        <p className="text-slate-500 mb-4">Unable to build knowledge base from compliance data</p>
        <button
          onClick={onRefresh}
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-900">{knowledgeBase.totalCompliant}</p>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-900">{knowledgeBase.totalWithEvidence}</p>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-900">{knowledgeBase.frameworks.length}</p>
              <p className="text-sm text-slate-500">Active Frameworks</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-slate-900">{Object.keys(controlsByDomain).length}</p>
              <p className="text-sm text-slate-500">Security Domains</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-200">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">AI context for questionnaire responses</p>
            </div>
          </div>
            ...
            <div className="divide-y divide-slate-100">
                    ...
                    <div className="bg-slate-50 border-t border-slate-100">
                      {controls
                        ...
                        .map(control => (
                          <div
                            key={control.id}
                            className="flex items-start gap-3 px-6 py-3 pl-12 border-b border-slate-100 last:border-b-0"
                          >
                            <div
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-sm text-slate-900 mt-0.5">{control.title}</p>
                              {control.evidence && (
              ...
              {Object.keys(controlsByDomain).length === 0 && (
                <div className="py-12 text-center">
                  ...
                  <p className="text-slate-500">No compliant controls found</p>
            ...
            <div className="divide-y divide-slate-100">
              {filteredEvidence.length > 0 ? (
                  ...
                  <div key={idx} className="flex items-start gap-3 px-6 py-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        <span className="text-xs font-mono text-slate-500">{item.controlId}</span>
                ...
                <div className="py-12 text-center">
                  ...
                  <p className="text-slate-500">No evidence items found</p>
                </div>
              )}
            </div>
          )}
            ...
            <div className="p-6">
              {knowledgeBase.frameworks.length > 0 ? (
                  ...
                  {knowledgeBase.frameworks.map(framework => (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-slate-900">{framework}</p>
                          <p className="text-xs text-slate-500">Active Framework</p>
                        </div>
                      </div>
                    </div>
                  ))}
                ...
                <div className="py-12 text-center">
                  ...
                  <p className="text-slate-500">No active frameworks</p>
                </div>
              )}
            </div>
          )}
      ...
      <div className="bg-violet-50 border border-violet-200 rounded-xl p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="font-medium text-violet-900">How the Knowledge Base Works</h4>
