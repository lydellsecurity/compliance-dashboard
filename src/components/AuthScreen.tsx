        ...
        <div className="bg-white backdrop-blur-xl rounded-2xl border border-slate-200 p-8 shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {mode === 'signup' && (
              <>
                <div>
                  <label htmlFor="auth-full-name" className="block text-sm font-medium text-slate-700 mb-1.5">
                    Full Name
                  </label>
                  <div className="relative">
                    <User className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400" aria-hidden />
                    <input
                      id="auth-full-name"
                      type="text"
                      value={fullName}
                ...
                <div>
                  <label htmlFor="auth-org-name" className="block text-sm font-medium text-slate-700 mb-1.5">
                    Organization Name
                  </label>
                  <div className="relative">
            ...
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400" aria-hidden />
                <input
                  id="auth-email"
                  type="email"
                  value={email}
            ...
            {mode !== 'forgot' && (
              <div>
                ...
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400" aria-hidden />
                  <input
                    id="auth-password"
